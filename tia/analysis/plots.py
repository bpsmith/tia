...
def plot_return_on_dollar(rets, title='Return on $1', show_maxdd=0, figsize=None, ax=None, append=0, label=None):
    ...
    ax = crets.plot(figsize=figsize, title=title, ax=ax, label=label)
